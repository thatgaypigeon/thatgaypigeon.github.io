...
with open("_static/json/search/other.json", "r", encoding="utf-8") as f:
...
with open("_static/json/search/other.json", "w", encoding="utf-8") as f:
    print("Writing site data...")
    f.write(json.dumps(data, indent=2, ensure_ascii=False))


with open("_static/json/search/wiki.json", "w", encoding="utf-8") as f:
